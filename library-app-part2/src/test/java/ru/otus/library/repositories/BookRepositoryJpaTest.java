...
@DataJpaTest
@Import({BookRepositoryJpa.class, AuthorRepositoryJpa.class, CategoryRepositoryJpa.class})
class BookRepositoryJpaTest {
    ...
    public void shouldUpdateIntoBD() {
        ...
        Optional<Book> actualUpdate = bookRepositoryJpa.update(bookUpdate);
        Optional<Book> afterUpdate = bookRepositoryJpa.findById(1);
    ...
    public void shouldGetById() {
        Book actual = bookRepositoryJpa.findById(1).orElseThrow();
    ...
    public void shouldDeleteById() {
        authorRepositoryJpa.delete(1);
        assertEquals(Optional.empty(), authorRepositoryJpa.findById(1));
    }
}